...
namespace App\Plugin\HimenoSena\Command;
...
class Assets extends Command
{
    ...
    public function mergeJs(): void
    {
        ...
        $commons = [
            ...
            "/app/Plugin/HimenoSena/Assets/Bootstrap/Js/Bootstrap.js",
            "/app/Plugin/HimenoSena/Assets/Pjax.js"
        ];

        $startTime = Date::timestamp();
        $this->info("[JS]开始压缩..");
        shell_exec($this->createUglifyjs($commons, "/app/Plugin/HimenoSena/Assets/Base.js"));
    ...
    public function mergeCss(): void
    {
        ...
        $index = [
            "/app/Plugin/HimenoSena/Assets/Bootstrap/Css/Bootstrap.css",
            "/app/Plugin/HimenoSena/Assets/Bootstrap/Font/BootstrapIcon.css",
            "/app/Plugin/HimenoSena/Assets/Style.css",
        ...
        shell_exec($this->createCss($index, "/app/Plugin/HimenoSena/Assets/Base.css"));
